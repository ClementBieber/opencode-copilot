...
| `INSTRUCTIONS.md` | deployment and file-structure detail overlaps with publication/deployment docs | `dist/skills/publication/*` | keep `INSTRUCTIONS.md` thin and move ownership to publication skill | completed |
